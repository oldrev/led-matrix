...
static bool checkreturn encode_array(
    pb_ostream_t* stream, const pb_field_t* field, const void* pData, size_t count, pb_encoder_t func);
...
static const pb_encoder_t PB_ENCODERS[PB_LTYPES_COUNT]
    = { &pb_enc_bool, &pb_enc_varint, &pb_enc_uvarint, &pb_enc_svarint, &pb_enc_fixed32, &pb_enc_fixed64,
